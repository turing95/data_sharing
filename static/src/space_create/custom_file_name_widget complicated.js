...
//         {{ req.file_naming_formula }}

//         <div id="textInput" class="focus-visible:outline-none placeholder-gray-500 my-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm p-2.5 min-h-[42px] focus:ring-blue-500 focus:border-blue-500 block w-full min-h-32 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type or paste emails addressess of invitees"></div>

//         <!-- Dropdown for Valid Tags -->
//         <select id="validTagsDropdown" class="dropdownClass bg-gray-50 border border-gray-300 text-gray-900 text-sm max-h-[42px] my-1">
//             <option value="" disabled selected>Insert parameter</option>
//             {% for tag in file_name_tags.tags %}
