...
urlpatterns = [
    ...
    path('field-groups/<uuid:group_uuid>/company-fields/create/', views.company_text_field_create,
    ...
    path('company-fields/<uuid:company_field_uuid>/duplicate/', views.company_text_field_duplicate,
