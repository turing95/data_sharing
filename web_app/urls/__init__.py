...
urlpatterns = [
    ...
    path('requests/<uuid:request_uuid>/set-order/', views.request_set_order, name='request_set_order'),
    path('spaces/<uuid:space_uuid>/update-order/', views.space_section_update_order, name='space_section_update_order'),
    path('spaces/<uuid:space_uuid>/set-order/', views.sections_set_order, name='sections_set_order'),
