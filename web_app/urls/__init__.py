...
urlpatterns = [
    ...
    path('organizations/<uuid:organization_uuid>/spaces/create/', views.SpaceCreateView.as_view(), name='space_create_v1'),
    ...
    path('spaces/<uuid:space_uuid>/request/create/', views.RequestCreateView.as_view(), name='request_create'),
