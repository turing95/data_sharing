...
urlpatterns = [
    ...
    path('upload-requests/<uuid:upload_request_uuid>/update-active/', views.upload_request_update_active,
         name='upload_request_update_active'),
    ...
    path('organizations/<uuid:organization_uuid>/organization-settings/', views.OrganizationSettingsView.as_view(), name='organization_settings'),
