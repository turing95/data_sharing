...
urlpatterns = [
    ...
    path('field-group-templates/<uuid:template_uuid>/', views.FieldTemplateDetailView.as_view(),
         name='company_template_detail'),
    path('company-templates/<uuid:company_template_uuid>/delete/', views.FieldTemplateDeleteView.as_view(),
         name='company_template_delete'),
    path('organizations/<uuid:organization_uuid>/company-templates/', views.FieldTemplatesListView.as_view(),
    ...
    path('text-fields/<uuid:text_field_uuid>/to-template/', views.text_field_to_template,
         name='text_field_to_template'),
    path('file-fields/<uuid:file_field_uuid>/to-template/', views.file_field_to_template,
         name='file_field_to_template'),
