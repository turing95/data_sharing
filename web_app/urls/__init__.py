...
urlpatterns = [
    ...
    path('spaces/<uuid:space_uuid>/upload-history/', views.UploadHistoryListView.as_view(), name='upload_history'),
    ...
    path('upload-requests/<uuid:upload_request_uuid>/update/', views.upload_request_update, name='upload_request_update'),
    path('spaces/<uuid:space_uuid>/history-table/', views.history_table, name='history_table'),
    path('spaces/<uuid:space_uuid>/edit/', views.space_edit, name='space_edit'),
