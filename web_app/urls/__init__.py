...
urlpatterns = [
    ...
    path('company-templates/<uuid:company_template_uuid>/', views.CompanyTemplateDetailView.as_view(),
         name='company_template_detail'),
    path('company-templates/<uuid:company_template_uuid>/delete/', views.CompanyTemplateDeleteView.as_view(),
         name='company_template_delete'),
    path('organizations/<uuid:organization_uuid>/company-templates/', views.CompanyTemplatesListView.as_view(),
    ...
    path('field-groups/<uuid:group_uuid>/company-fields/create/', views.company_field_create,
         name='company_field_create'),
    path('field-groups/<uuid:group_uuid>/add-template/<uuid:template_uuid>/', views.company_field_group_add_template,
         name='company_field_group_add_template'),
    path('field-groups/<uuid:group_uuid>/to-template/', views.company_field_group_to_template,
         name='company_field_group_to_template'),
    path('company-fields/<uuid:company_field_uuid>/to-template/', views.company_field_to_template,
         name='company_field_to_template'),
    path('field-groups/<uuid:group_uuid>/company-field/create/modal/', views.company_field_create_modal,
         name='company_field_create_modal'),
    path('field-groups/<uuid:group_uuid>/company-field-group/create/modal/', views.company_field_group_create_modal,
         name='company_field_group_create_modal'),
    path('field-groups/<uuid:group_uuid>/company-field-group/create/', views.company_field_group_create,
         name='company_field_group_create'),
    path('company-fields/<uuid:company_field_uuid>/update/modal/', views.company_field_update_modal,
         name='company_field_update_modal'),
    path('company-fields/<uuid:company_field_uuid>/duplicate/', views.company_field_duplicate,
         name='company_field_duplicate'),
    path('field-groups/<uuid:group_uuid>/elements/', views.group_elements,
         name='group_elements'),
    path('field-groups/<uuid:group_uuid>/update/modal/', views.company_field_group_update_modal,
         name='company_field_group_update_modal'),
    path('field-groups/<uuid:group_uuid>/update/', views.company_field_group_update,
         name='company_field_group_update'),
    path('company-fields/<uuid:company_field_uuid>/update/', views.company_field_update, name='company_field_update'),
    path('company-fields/<uuid:company_field_uuid>/detail/', views.company_field_detail,
         name='company_field_detail'),
    path('company-fields/<uuid:company_field_uuid>/delete/', views.company_field_delete, name='company_field_delete'),
    path('field-groups/<uuid:group_uuid>/delete/', views.company_field_group_delete, name='company_field_group_delete'),
