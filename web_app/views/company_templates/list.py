...
from web_app.models import Organization, CompanyFieldGroup


class CompanyTemplatesListView(OrganizationMixin, CompanySideBarMixin, SubscriptionMixin, ListView):
