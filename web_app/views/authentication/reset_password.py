...
class PasswordResetDoneView(AllauthPasswordResetDoneView):
    template_name = 'public/authentication/password_reset_done.html'


class PasswordResetFromKeyView(AllauthPasswordResetFromKeyView):
    template_name = 'public/authentication/password_reset_from_key.html'


class PasswordResetFromKeyDoneView(AllauthPasswordResetFromKeyDoneView):
    template_name = 'public/authentication/password_reset_from_key_done.html'
